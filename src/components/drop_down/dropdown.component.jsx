...
class dropdown extends React.Component {
  ...
  toggleArrow(e) {
    ...
    if (carat) {
      if (carat.className === "triangle-top") {
        carat.className = "triangle-bottom";
      }
      else {
        carat.className = "triangle-top";
      }
    }
  }
  ...
  getTrigger() {
    ...
    if (this.props.triggerType && this.props.trigger) {
        ...
        case "image":
          ...
          return (
            <div onClick={this.toggleMenu}>
              ...
              <span id={this.CARAT_CLASS} className="triangle-bottom" style={caratStyle}></span>
            </div>
          );
        case "text":
          return (
      ...
      return (
        <span className="menutoggle" style={iconCss} onClick={this.toggleMenu}></span>
      );
    }
  }
