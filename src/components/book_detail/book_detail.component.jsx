  ...
  return (
    <div>
      ...
      <div className="top">
        ...
        <div className="header_corner">♡</div>
        <div className="right">
          <p>
            <b>{book.book_title}</b>
            <br />
          ...
          <p>
            ...
            {book.age} <br />
            {book.wordcount} Words; {book.chapters.length} Chapters;{" "}
            {book.likes.length} Likes
            <br />
            <span className="review">Reviews ({book.reviews.length})</span>
          </p>
          <p>
            What a way to start a new school year! Jennifer discovers that
            there's a serial killer that attends her school as a student. The
            serial killer then starts to leave clues in her locker. Confused and
            scared, she's now trapped in a mystery that she never wanted to be a
            part of.
          </p>
        </div>
      </div>
